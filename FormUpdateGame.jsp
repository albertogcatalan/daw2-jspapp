      ...
      <div class="hero-unit">
        	...
        	<div class="row-fluid">
			  <div class="span12">
			    ...
			    <div class="row-fluid">
			      <div class="span4"></div>
			      <div class="span5"><h1>Editar</h1>
				      		 <label for="title">Título</label>
            
            <input type="hidden" value="<c:out value="${game.id}"/>" name="id">
            <input id="title" name="title" class="input-xlarge" type="text" placeholder="Escribe el título" value="<c:out value="${game.title}"/>">
        <c:forEach var="item" items="${errors}">
        	...
        	<label for="release_date">Fecha publicación</label>
                        <input id="release_date" class="input-xlarge" type="text" name="release_date" placeholder="YYYY-DD-MM" value="<c:out value="${game.release_date}"/>">
        ...
        <c:forEach var="item" items="${errors}">
            ...
            <input id="publisher" class="input-xlarge" type="text" name="publisher" placeholder="Konami, Capcom, Square Enix..." value="<c:out value="${game.publisher}"/>">
...
<c:forEach var="item" items="${errors}">
            ...
            <input id="system" class="input-xlarge" type="text" name="system" placeholder="PS3, PC, Wii, Xbox..." value="<c:out value="${game.system}"/>">
...
<c:forEach var="item" items="${errors}">
            ...
            <input id="rating" class="input-xlarge" type="text" name="rating" placeholder="10" value="<c:out value="${game.rating}"/>">
        ...
        <c:forEach var="item" items="${errors}">
            ...
            <input id="num_players" class="input-xlarge" type="text" name="num_players" placeholder="2" value="<c:out value="${game.num_players}"/>">
        <c:forEach var="item" items="${errors}">
